...
with open('web/app/vendor/pin/page.tsx', 'w') as f:
    f.write('\n'.join(pin_set))
print('✓ web/app/vendor/pin/page.tsx written')

with open('web/app/vendor/pin-login/page.tsx', 'w') as f:
    f.write('\n'.join(pin_login))
print('✓ web/app/vendor/pin-login/page.tsx written')

print('\nNext: git add -A && git commit -m "Fix: pin pages — no template literal escaping issues" && git push')
