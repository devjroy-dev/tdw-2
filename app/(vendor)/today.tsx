  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        >
          <Text style={{ fontFamily: DM300, fontSize: 8, letterSpacing: 1, textTransform: 'uppercase', color: GOLD, opacity: 0.4 }}>
            SIGN OUT
          </Text>
        </TouchableOpacity>
      </Animated.ScrollView>
...
const styles = StyleSheet.create({
  ...
  introWordmark: { fontFamily: JOST200, fontSize: 9, letterSpacing: 2.2, textTransform: 'uppercase', color: '#555250', textAlign: 'center', marginBottom: 16 },
  ...
  introStepSub: { fontFamily: JOST, fontSize: 9, letterSpacing: 1, color: GOLD },
  ...
  introCtaText: { fontFamily: JOST, fontSize: 11, letterSpacing: 1.8, textTransform: 'uppercase', color: INK },
  ...
  // Section label
  sectionLabel: { fontFamily: JOST200, fontSize: 9, letterSpacing: 2.2, textTransform: 'uppercase', color: '#555250', marginBottom: 14 },
  ...
  qaLabel: { fontFamily: JOST, fontSize: 9, letterSpacing: 1, textTransform: 'uppercase', color: CREAM },
  ...
  nudgeCta: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, color: GOLD, flexShrink: 0 },
  ...
  urgencyLabel: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: GOLD, marginBottom: 6 },
  ...
  urgencyCta: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: GOLD },
  ...
  gentleNudgeCta: { fontFamily: JOST, fontSize: 9, letterSpacing: 1, textTransform: 'uppercase', color: GOLD, flexShrink: 0, marginLeft: 12 },
  ...
  waBetaText: { fontFamily: JOST, fontSize: 7, letterSpacing: 1, color: GOLD },
  ...
  waBtnText: { fontFamily: JOST, fontSize: 9, letterSpacing: 1, textTransform: 'uppercase', color: GOLD },
  waDismiss: { fontFamily: JOST, fontSize: 8, letterSpacing: 1, textTransform: 'uppercase', color: 'rgba(248,247,245,0.25)', paddingVertical: 8 },
  ...
  onboardingCta: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: GOLD },
  onboardingDone: { fontFamily: JOST, fontSize: 8, letterSpacing: 1, textTransform: 'uppercase', color: '#C8C4BE' },
  ...
  attentionCta: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase' },
  overdueTag: { backgroundColor: 'rgba(201,168,76,0.08)', borderRadius: 100, paddingHorizontal: 8, paddingVertical: 3 },
  overdueTagText: { fontFamily: JOST, fontSize: 9, letterSpacing: 1, color: GOLD },
  ...
  snapLabel: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, color: MUTED, textAlign: 'center', marginVertical: 2 },
  ...
  tipLabel: { fontFamily: JOST, fontSize: 8, letterSpacing: 1.8, textTransform: 'uppercase', color: GOLD },
  tipText: { fontFamily: DM300, fontSize: 12, color: MUTED, flex: 1, lineHeight: 17 },
  tipTitle: { fontFamily: DM400, fontSize: 12, color: '#555250' },
  tipMore: { fontFamily: JOST, fontSize: 8, letterSpacing: 1, textTransform: 'uppercase', color: GOLD, flexShrink: 0 },
  ...
  dreamaiLabel: { fontFamily: JOST, fontSize: 9, letterSpacing: 1.8, textTransform: 'uppercase', color: MUTED, marginRight: 4 },
