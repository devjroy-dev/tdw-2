"""
DREAMAI FAB — Write component file to disk
Repo: tdw-2

The DreamAiFAB.tsx file was never in the repo.
This script creates it at the correct path.

Run from: /workspaces/tdw-2
Command:  python3 create_dreamai_fab.py
"""
...
print(f'✓ Created {FAB_PATH}')
print('\nNext: git add -A && git commit -m "Fix: add DreamAiFAB component — was missing from repo" && git push')
