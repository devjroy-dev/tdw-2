...
API  = 'https://dream-wedding-production-89ae.up.railway.app'
GOLD = '#C9A84C'
...
os.makedirs('web/app/couple/pin', exist_ok=True)
os.makedirs('web/app/couple/pin-login', exist_ok=True)

with open('web/app/couple/pin/page.tsx', 'w') as f:
    f.write('\n'.join(pin_set))
print('✓ web/app/couple/pin/page.tsx — dark carousel rewrite (DREAMER PORTAL)')

with open('web/app/couple/pin-login/page.tsx', 'w') as f:
    f.write('\n'.join(pin_login))
print('✓ web/app/couple/pin-login/page.tsx — dark carousel rewrite (DREAMER PORTAL)')

print('\nNext: git add -A && git commit -m "Design: couple PIN pages — dark carousel matching vendor" && git push')
